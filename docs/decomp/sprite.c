        ...
        if ( *i & 0xF0 )
        {
            ...
            while ( 1 )
            {
                ...
                if ( v7 >= 24 )
                {
                    ...
                    v10 = v9;
                    v11 = *v9 >> 8;
                    if ( &v15[v11] < ePAScratch_2033000 && byte_200DCA0[0] < 12 )
                    {
                        v12 = byte_200DCA0[0];
...
signed int __fastcall sprite_decompress(int a1, int a2)
{
    ...
    v6 = v5;
    v7 = *v5 >> 8;
    if ( dword_200DCEC + v7 >= ePAScratch_2033000 || byte_200DCA0[0] >= 12 )
        return 0;
    v8 = byte_200DCA0[0];
...
signed int __fastcall sprite_decompressTemp(int a1, int a2)
{
    ...
    while ( v2 != *&byte_200DCA0[v4 + 4] )
    {
        ...
        if ( v4 >= 24 )
        {
            ...
            {
                v6 = ((2 * v5) >> 1);
                if ( dword_200DCEC + (*v6 >> 8) < ePAScratch_2033000 && byte_200DCA0[0] < 12 )
                {
                    v7 = byte_200DCA0[0];
